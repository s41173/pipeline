...
-->
               ...
               <div class="form-group">
                ...
                <?php $js = "class='select2_single form-control' id='ccolor' tabindex='-1' style='width:200px;' "; 
			        echo form_dropdown('ccolor', $model, isset($default['color']) ? $default['color'] : '', $js); ?>
              </div>
               
              <div class="form-group">
                <label> Size </label> <br>
                <?php $js = "class='select2_single form-control' id='csize' tabindex='-1' style='width:100px;' "; 
			        echo form_dropdown('csize', $size, isset($default['size']) ? $default['size'] : '', $js); ?>
              </div>   
               
              <div class="form-group">
                <label> Type </label> <br>  
                <select name="ctype" id="ctype" class="select2_single form-control" style="min-width:120px;">
