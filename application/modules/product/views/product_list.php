...
<?php $js = "class='form-control' id='cmanufacture' tabindex='-1' style='width:170px;' "; 
 echo form_dropdown('cmanufacture', $manufacture, isset($default['manufacture']) ? $default['manufacture'] : '', $js); ?>
              </div>
        
         <div class="form-group">
<label> Category </label> <br>
<?php $js = "class='form-control' id='ccategory' tabindex='-1' style='width:170px;' "; 
 echo form_dropdown('ccategory', $category, isset($default['category']) ? $default['category'] : '', $js); ?>
              </div>   
        
        <div class="form-group">
<label> Model </label> <br>
<?php $js = "class='form-control select2_single' id='cmodel' tabindex='-1' style='width:220px;' "; 
