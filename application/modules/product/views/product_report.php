        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Sku', dataField: 'Sku', width : 180 },
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <div id='jqxWidget'>
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> Sku </th> <th> Type </th> <th> Category </th> <th> Manufacture </th> <th> Name </th> <th> Model </th> <th> Currency </th>
		  ...
		  <?php 
              ...
              function type($val){ if ($val==0){ return 'Raw'; }else{ return 'Assembly'; } }
