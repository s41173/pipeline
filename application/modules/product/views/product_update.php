  ...
  <div id="step-1">
    ...
    action="<?php echo $form_action.'/1'; ?>" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
<?php $js = "class='select2_single form-control' id='cunit' tabindex='-1' style='width:150px;' "; 
echo form_dropdown('cunit', $unit, isset($default['unit']) ? $default['unit'] : '', $js); ?>
        </div>
      </div>
...
<option value="0"<?php echo set_select('ctype', '0', isset($default['type']) && $default['type'] == '0' ? TRUE : FALSE); ?>> Raw 
</option>
<option value="1"<?php echo set_select('ctype', '1', isset($default['type']) && $default['type'] == '1' ? TRUE : FALSE); ?>> Assembly 
</option>
         </select>
        </div>
      </div>
