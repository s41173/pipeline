      ...
      enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-12">
                      <input type="text" name="tcode" id="" class="form-control" placeholder="Code">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type="text" name="tname" id="" class="form-control" placeholder="Name">
                    </div>
                  </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12">
                      <input type="number" name="tperiod" id="" class="form-control" placeholder="">
                    </div>
                  </div>
...
<textarea name="tdesc" id="" class="form-control" rows="3" placeholder="Description"><?php echo set_value('tdesc', isset($default['desc']) ? $default['desc'] : ''); ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
<input type="text" name="taccumulation" id="titem" class="form-control" required readonly style="max-width:120px; float:left;"> 
<?php echo anchor_popup(site_url("account/get_list/titem/"), '[ ... ]', $atts1); ?> 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
<input type="text" name="tdepreciation" id="titem6" class="form-control" required readonly style="max-width:120px; float:left;"> 
