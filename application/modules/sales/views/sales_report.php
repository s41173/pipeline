			...
			var rows = $("#table tbody tr");
                ...
                var source = {
                    ...
                    [
                        ...
                        { name: "Discount-Desc", type: "string" },
...
{ text: 'Discount', dataField: 'Discount', width : 150, cellsalign: 'right', cellsformat: 'number', aggregates: ['sum'] },    
                  { text: 'Discount-Desc', dataField: 'Discount-Desc', width : 150 },
...
<th> Discount </th> <th> Discount-Desc </th>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
                       ...
                       <td class=\"strongs\">".intval($res->total)."</td>
                       <td class=\"strongs\">".$res->discount."</td>
                       <td class=\"strongs\">".strtoupper($res->discount_desc)."</td>
