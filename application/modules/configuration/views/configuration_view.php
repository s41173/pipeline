...
<script type="text/javascript">
    ...
    var sites_otp  = "<?php echo site_url('configuration/setotp/');?>";
...
<div id="wizard" class="form_wizard wizard_horizontal">
  ...
  <div id="step-1">
    ...
    <form class="form-horizontal form-label-left" id="ajaxform" method="post" action="<?php echo $form_action1; ?>">
      ...
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Token OTP </label> 
        <table style="margin-left:10px; float:left;">
            <tr>
<td> 
<input type="number" class="form-control" id="totp" name="totp" placeholder="OTP" required style="margin-right:5px; width: 120px;"> </td>
<td> 
<input type="number" maxlength="8" class="form-control" id="tpin" name="tpin" placeholder="pin" style="width:120px;"> 
</td>
<td> <button type="button" class="btn btn-primary" id="botp" style="margin:5px;"> SET OTP </button> </td>                
            </tr>
        </table>  
