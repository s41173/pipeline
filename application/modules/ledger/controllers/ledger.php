...
//        $data['graph'] = $this->chart($this->input->post('ccurrency'),$this->account->get_id_code($acc));
	...
	$data['form_action'] = site_url($this->title.'/search');
        ...
        $data['link'] = array('link_back' => anchor('account','Back', array('class' => 'btn btn-danger')));
...
// ====================================== REPORT =========================================
	...
	$data['form_action'] = site_url($this->title.'/report_process/1');
    ...
    function report_process($type=0)
    {
        $this->acl->otentikasi2($this->title);
