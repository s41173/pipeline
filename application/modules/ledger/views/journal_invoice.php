		   ...
		   <?php
                ...
                function get_prev_balance($pid=null,$date=null){
                    ...
                    if ($pid != null && $date != null){
                        ...
                        $opening = get_begin_balance($pid, $date);
                        ...
                        $res_trans = get_end_balance($pid, $tglawal, $prevdate);
//                        return $opening+$res_trans;
				...
				{    
					...
					$begin = get_prev_balance($acc,$start);
		   		...
		   		foreach($accounts as $account)
				{
				  echo"
	                ...
	                <tr> <td colspan=\"6\"> Beginning Balance : </td> <td align=\"right\"> ".num_format(get_prev_balance($account->id,$start))." </td> </tr>
	...
	echo "<tr> <td> Beginning Balance : </td> <td align=\"right\">".num_format(get_prev_balance($account->id,$start))."</td> <td></td> 
	      ...
	      <tr> <td> Ending Balance : </td> 
		       <td align=\"right\"> ".num_format(intval(get_prev_balance($account->id,$start)+get_end_balance($account->id,$start,$end)))." </td> <td></td> 
