 ...
 <!-- searching form -->
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_item; ?>">
      ...
      <div class="form-group">
        ...
        <input type="number" name="tamount" id="tamount" class="form-control" style="width:100px;" maxlength="8" required value="0"> &nbsp;
      </div>      
      ...
      <div class="form-group">
        <label class="control-label labelx"> SO </label> <br>
<?php $js = "class='select2_single form-control' id='cbranch' tabindex='-1' style='min-width:160px;' "; 
echo form_dropdown('csales', $sales, isset($default['']) ? $default[''] : '', $js); ?>
          &nbsp;
      </div>  
       
      <div class="form-group">
        <label class="control-label labelx"> Picker Staff </label> <br>
        <input type="text" name="tdesc" id="tdesc" class="form-control" style="width:160px;" maxlength="8" required> &nbsp;
      </div>      
      ...
      <table class="table table-striped jambo_table bulk_action">
        <thead>
          <tr class="headings">
            ...
            <th class="column-title"> SO </th>
            <th class="column-title"> Picker </th>
        ...
        <?php
            ...
            {
                $acc = new Product_lib();
                return $acc->get_sku($val).' <br> '.$acc->get_name($val).' - '.$acc->get_name($val,'model');
            }
            ...
            function sales($val=null){
                if ($val){ return 'SO-0'.$val; }else{ return '-'; }
            }
