...
<script type="text/javascript">
	...
	var source = "<?php echo $source;?>";
       ...
       <div class="form-group">
           <label> SO : </label> <br>
           <?php $js = "class='select2_single form-control' id='csales' tabindex='-1' style='min-width:150px;' "; 
echo form_dropdown('csales', $sales, isset($default['sales']) ? $default['sales'] : '', $js); ?>
       </div>       
