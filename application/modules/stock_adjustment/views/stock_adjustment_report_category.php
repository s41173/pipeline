        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'SO', dataField: 'SO', width : 100 },
			...
			{
				var site = "<?php echo site_url('stock_adjustment/invoice/');?>";
				window.open(site+"/"+val+"/1", "", "width=800, height=600"); 
//				alert(site+"/"+val+"/1");
			}
...
<table id="table" border="0">
 <thead>
 <tr>
 <th>No</th> <th>Date</th> <th> Code </th> <th> Type </th> <th> SO </th> <th> Product </th> <th> Qty </th> <th> Amount </th> <th> Balance </th>
 </tr>
 </thead>
  ...
  <?php 	
      ...
      if ($reports_category)
      {
        ...
        {	
           ...
           <td class=\"strongs\" align=\"center\">".sales($res->sales_id)."</td>
