        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Product', dataField: 'Product', cellsalign: 'center', width: 250 },
                  ...
                  { text: 'SO', dataField: 'SO', cellsalign: 'center', width: 80 },
                  { text: 'Picker', dataField: 'Picker', cellsalign: 'center', width: 120 },
...
<div id="container">
	...
	<table width="100%" style="font-size:1em; margin:0; text-align:left; font-weight:bold;">
      ...
      <tr> <td> SO </td> <td>:</td> <td> <?php echo isset($sales) ? $sales : ''; ?> </td> </tr>
	</table>
	</div>
    ...
    <div id='jqxWidget'>
		...
		<table id="table">
        <thead>
	    <tr>  <th> No </th> <th> Type </th> <th> Product </th> <th> Qty </th> <th> Amount </th> <th> Balance </th> <th> SO </th> <th> Picker </th> </tr>	
        </thead>
...
<td class=\"left\"> ".product($res->product_id,'sku').' - '.product($res->product_id,'name')." </td> 
                    ...
                    <td class=\"right\"> ".sales($res->sales_id)." </td>
                    <td class=\"right\"> ".ucfirst($res->notes)." </td>
				 </tr>
