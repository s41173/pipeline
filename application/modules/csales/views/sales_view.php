...
<script type="text/javascript">
    ...
    var sites_confirmation  = "<?php echo site_url('csales/confirmation/');?>";
    var sites_print_invoice  = "<?php echo site_url('csales/invoice/');?>";
    var sites_primary   = "<?php echo site_url('csales/publish/');?>";
	var sites_attribute = "<?php echo site_url('csales/attribute/');?>";
...
<form class="form-inline" id="cekallform" method="post" action="<?php echo ! empty($form_action_del) ? $form_action_del : ''; ?>">
      ...
      <!-- Check All Function -->
            ...
            <div class="btn-group">
            <a class="btn btn-primary" href="<?php echo site_url('csales/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New </a>
