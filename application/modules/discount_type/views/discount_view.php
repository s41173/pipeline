...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('discount_type/add_process/');?>";
	var sites_edit = "<?php echo site_url('discount_type/update_process/');?>";
	var sites_del  = "<?php echo site_url('discount_type/delete/');?>";
	var sites_get  = "<?php echo site_url('discount_type/update/');?>";
