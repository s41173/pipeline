...
class Customer extends MX_Controller
{
	...
	// ---------------------------------------- //
        ...
        $this->table->set_heading('#','No', 'Type', 'Name', 'Phone', 'Email', 'City', 'Joined', 'Action');
	...
	// Form validation
        ...
        $this->form_validation->set_rules('temail', 'Email', 'valid_email|callback_valid_email');
...
//            redirect($this->title);
	...
	// Form validation
        ...
        $this->form_validation->set_rules('tfname', 'FirstName', '');
        $this->form_validation->set_rules('tlname', 'Name', 'required');
        $this->form_validation->set_rules('ctype', 'Customer Type', 'required');
        $this->form_validation->set_rules('taddress', 'Address', 'required');
        $this->form_validation->set_rules('tphone1', 'Phone 1', 'required');
