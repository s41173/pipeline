...
<script type="text/javascript">
    ...
    var sites_ajax  = "<?php echo site_url('ar_payment/');?>";
	var source = "<?php echo $source;?>";
      ...
      <div class="form-group">
	       ...
	       echo form_dropdown('cvendor', $customer, isset($default['vendor']) ? $default['vendor'] : '', $js); ?>
       </div>           
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('ar_payment/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New  </a>
   <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal2"> Report  </button>
   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal3"> Receivable Card  </button>
