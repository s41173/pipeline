...
//            
    ...
    function add_item($uid=0)
    {
        ...
        $this->form_validation->set_rules('tcontractqty', 'Contract Qty', 'required|numeric');
        $this->form_validation->set_rules('toustandingqty', 'Outstanding Qty', 'required|numeric');
        $this->form_validation->set_rules('ttransferqty', 'Transfer Qty', 'required|numeric');
