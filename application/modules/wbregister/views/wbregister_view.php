...
<script src="<?php echo base_url(); ?>js/moduljs/wbregister.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('wbregister/add_process/');?>";
	var sites_edit = "<?php echo site_url('wbregister/update_process/');?>";
	var sites_del  = "<?php echo site_url('wbregister/delete/');?>";
	var sites_get  = "<?php echo site_url('wbregister/update/');?>";
    var sites_primary  = "<?php echo site_url('wbregister/publish/');?>";
 ...
 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-plus"></i>&nbsp;Add New </button>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('wbregister_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
