...
<script src="<?php echo base_url(); ?>js/moduljs/asset.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('asset/add_process/');?>";
	var sites_edit = "<?php echo site_url('asset/update_process/');?>";
	var sites_del  = "<?php echo site_url('asset/delete/');?>";
	var sites_get  = "<?php echo site_url('asset/update/');?>";
    var sites_primary  = "<?php echo site_url('asset/publish/');?>";
    var sites  = "<?php echo site_url('asset/');?>";
 ...
 <a class="btn btn-success" href="<?php echo site_url('groupasset'); ?>"> Group Asset </a>
...
-->
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('asset_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
      
      <!-- Modal Edit Form -->
      <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	     <?php $this->load->view('asset_update'); ?> 
      </div>
      <!-- Modal Edit Form -->
