...
<script type="text/javascript">
    ...
    var sites_ajax  = "<?php echo site_url('assembly/');?>";
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('assembly/add'); ?>"> 
       <i class="fa fa-plus"></i>&nbsp;Add New  </a>
       
   <a class="btn btn-success" href="<?php echo site_url('assembly_formula'); ?>"> Assembly Formula </a>   
