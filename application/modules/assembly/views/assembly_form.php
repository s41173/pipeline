...
<script src="<?php echo base_url(); ?>js/moduljs/assembly.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('assembly/add_process/');?>";
	var sites_edit = "<?php echo site_url('assembly/update_process/');?>";
	var sites_del  = "<?php echo site_url('assembly/delete/');?>";
	var sites_get  = "<?php echo site_url('assembly/update/');?>";
    var sites  = "<?php echo site_url('assembly/');?>";
...
<input type="text" name="ttotal" class="form-control" readonly value="<?php echo isset($default['total']) ? $default['total'] : '' ?>"> 
  </td>    
</tr>
</table>
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_item; ?>">
       ...
       <div class="form-group">
        <label class="control-label labelx"> Product </label> <br>
          ...
          <?php echo anchor_popup(site_url("product/get_list/titems2"), '[ ... ]', $atts2); ?>
   ...
   <form id="ajaxtransform2" class="form-inline" method="post" action="<?php echo $form_action_cost; ?>">
      ...
      <div class="form-group">
        <label class="control-label labelx"> Notes </label> <br>
           <textarea class="form-control" name="tnotes" cols="30"></textarea> &nbsp;
      </div>
                     
      <div class="form-group">
        <label class="control-label labelx"> Amount </label> <br>
        <input type="number" name="tamount" id="tamount" class="form-control" style="width:130px;" maxlength="8" required> &nbsp;
      </div>          
