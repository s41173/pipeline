...
<script type="text/javascript">
    ...
    var sites_product_list = "<?php echo site_url('product/get_list/');?>";
...
<div class="row">
 ...
 <!-- searching form -->
   ...
   <form id="posform" class="form-inline" method="post">
      <div class="form-group">
        <label class="control-label labelx"> Product </label> <br>
          
                 
        <select name="ctype" id="ctype" class="form-control" style="float:left; margin-right:5px;">
            <option value="0"> Raw </option>
            <option value="1"> Assemblies </option>
        </select>    
          
        <input id="titems" class="form-control col-md-2 col-xs-12" type="text" name="cproduct" required style="width:150px;">
        <div class="btn-group">  
        <input type="hidden" id="hbranch" value="<?php echo $branch; ?>">        
        <?php //echo anchor_popup(site_url("product/get_list/titems/".$branch), '[ ... ]', $atts2); ?>
        <button type="button" id="brpductwindow" class="btn btn-primary button_inline"> [ ... ] </button>
