...
class Custom_Model extends CI_Model {
    ...
    function update($uid, $users, $field=null)
    {
        ...
        $this->logs->insert($this->session->userdata('userid'), date('Y-m-d'), waktuindo(), 'update', 0, $field, $next, $prev);
    ...
    function delete($uid,$field=null)
    {
        ...
        $this->logs->insert($this->session->userdata('userid'), date('Y-m-d'), waktuindo(), 'delete',0, $field, $prev);
    ...
    function add($users)
    {
        $this->logs->insert($this->session->userdata('userid'), date('Y-m-d'), waktuindo(), 'create', 0, null, json_encode($users));
