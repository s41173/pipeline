$(document).ready(function (e) {
	...
	// tamount keyup
	$("#tamount").keyup(function(e){
		// $("input").css("background-color", "pink");
		let tax = parseFloat($("#ctax").val());
		let amount = parseInt($('#tamount').val());
		let taxval = parseInt(tax*amount);
		$("#ttax").val(taxval);
		$("#ttotal").val(taxval+amount);
	});

	$("#ctax").change(function(e){
		// $("input").css("background-color", "pink");
		let tax = parseFloat($("#ctax").val());
		let amount = parseInt($('#tamount').val());
		let taxval = parseInt(tax*amount);
