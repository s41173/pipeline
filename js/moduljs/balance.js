	...
	{	
		...
		$.ajax({
			...
			success: function(result) {
				...
				$("#tbalance_update").val(res[3]);
			}
		})
		return false;	
	});

	$(document).on('click','#bresetbalance',function(e)
	{	
		e.preventDefault();
		var element = $(this);
		var url = sites_reset;
...
'<a href="" class="btn btn-default btn-xs text-primary" id="' +s[i][0]+ '" title=""> <i class="fa fas-2x fa-edit"> | Balance </i> </a>'+
'</div>'
										    ]);										
											} // End For 
