$(document).ready(function (e) {
	...
	// fungsi contract select
	$(document).on('change','#ccontract',function(e)
	{	
		e.preventDefault();
		var element = $(this);
		if (element.val() !== null){ $('#ccustomer').prop('disabled', true);}else{ $('#ccustomer').prop('disabled', false); } 
	});
   ...
   // fungsi ajax form sales
	...
	{	
		...
		// fungsi ajax calculate tax
	$(document).on('change','#ctax',function(e)
	{	
		e.preventDefault();
		var value = parseFloat($("#ctax").val());
		var amount = parseInt($('#tamount').val());
		var res = value*amount+amount;
		$('#ttax').val(value*amount);
	});

	// calculate amount
	$(document).on('keyup','#tamount',function(e)
	{	
		e.preventDefault();
		var value = parseFloat($("#ctax").val());
		var amount = parseInt($('#tamount').val());
